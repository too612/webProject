...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<ApiResponse<Map<String, Object>>> login(@RequestBody UserController.LoginRequest request,
            HttpSession session) {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> register(
            @RequestBody UserController.RegisterRequest request) {
