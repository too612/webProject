package com.main.app.official.nextgen.school;
...
import com.main.app.official.nextgen.school.dto.ChildrenRequest;

import jakarta.servlet.http.HttpSession;

@RestController
@RequestMapping("/api/official/nextgen/school")
public class ChildrenController {

    private static final String BASE_PATH = "/nextgen/school";
    ...
    @PostMapping("/write")
    public ApiResponse<Map<String, String>> save(ChildrenRequest request,
    ...
    @PostMapping("/update")
    public ApiResponse<Map<String, String>> update(ChildrenRequest request,
            @RequestParam(name = "files", required = false) List<MultipartFile> files) {
