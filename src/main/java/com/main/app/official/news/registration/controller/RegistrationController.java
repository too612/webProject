package com.main.app.official.news.registration.controller;
...
import com.main.app.official.news.registration.service.RegistrationService;
...
public class RegistrationController {
    ...
    public ResponseEntity<Resource> download(@RequestParam("fileId") Long fileId) throws MalformedURLException {
        FileDto file = registrationService.getFile(fileId);
