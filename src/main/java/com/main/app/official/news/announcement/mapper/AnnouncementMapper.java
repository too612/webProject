package com.main.app.official.news.announcement.mapper;
...
public class AnnouncementMapper {
    ...
    private static final String BOARD_TYPE = "ANNOUNCEMENT";

    private final AnnouncementBoardMapper boardMapper;

    public AnnouncementMapper(AnnouncementBoardMapper boardMapper) {
        this.boardMapper = boardMapper;
    }

    public List<AnnouncementDto> selectBoardList(Pageable pageable, String searchType, String keyword) {
    ...
    public AnnouncementDto selectBoardDetail(String rqstNo, boolean increaseViewCount) {
        Map<String, Object> params = new HashMap<>();
    ...
    public void insertBoard(AnnouncementRequest request) {
        boardMapper.insertBoard(request);
    }

    public void updateBoard(AnnouncementRequest request) {
