package com.main.app.official.news.registration.mapper;
...
public class RegistrationMapper {
    ...
    private static final String BOARD_TYPE = "REGISTRATION";

    private final RegistrationBoardMapper boardMapper;

    public RegistrationMapper(RegistrationBoardMapper boardMapper) {
        this.boardMapper = boardMapper;
    }

    public List<RegistrationDto> selectBoardList(Pageable pageable, String searchType, String keyword) {
    ...
    public RegistrationDto selectBoardDetail(String rqstNo, boolean increaseViewCount) {
        Map<String, Object> params = new HashMap<>();
    ...
    public void insertBoard(RegistrationRequest request) {
        boardMapper.insertBoard(request);
    }

    public void updateBoard(RegistrationRequest request) {
