package com.main.app.official.worship.mapper;
...
public class SermonMapper {
    ...
    private static final String BOARD_TYPE = "SERMONS";

    private final SermonBoardMapper boardMapper;

    public SermonMapper(SermonBoardMapper boardMapper) {
        this.boardMapper = boardMapper;
    }

    public List<SermonDto> selectBoardList(Pageable pageable, String searchType, String keyword) {
    ...
    public SermonDto selectBoardDetail(String rqstNo, boolean increaseViewCount) {
        Map<String, Object> params = new HashMap<>();
    ...
    public void insertBoard(SermonRequest request) {
