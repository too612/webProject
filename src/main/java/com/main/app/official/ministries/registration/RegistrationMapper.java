...
public interface RegistrationMapper {
    ...
    List<RegistrationDto> selectBoardList(Map<String, Object> params);

    long countBoardList(Map<String, Object> params);

    RegistrationDto selectBoardDetail(Map<String, Object> params);

    void updateReadCount(Map<String, Object> params);

    void insertBoard(RegistrationRequest request);

    void updateBoard(RegistrationRequest request);
