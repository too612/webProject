package com.main.app.official.ministries.children.controller;
...
import com.main.app.official.ministries.children.service.ChildrenService;
...
public class ChildrenController {
    ...
    private static final String BASE_PATH = "/ministries/children";
    ...
    public ResponseEntity<Resource> download(@RequestParam("fileId") Long fileId) throws MalformedURLException {
        FileDto file = childrenService.getFile(fileId);
