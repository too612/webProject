package com.main.app.official.ministries.children.mapper;
...
public class ChildrenMapper {
    ...
    private static final String BOARD_TYPE = "CHILDREN";

    private final ChildrenBoardMapper boardMapper;

    public ChildrenMapper(ChildrenBoardMapper boardMapper) {
        this.boardMapper = boardMapper;
    }

    public List<ChildrenDto> selectBoardList(Pageable pageable, String searchType, String keyword) {
    ...
    public ChildrenDto selectBoardDetail(String rqstNo, boolean increaseViewCount) {
        Map<String, Object> params = new HashMap<>();
    ...
    public void insertBoard(ChildrenRequest request) {
        boardMapper.insertBoard(request);
    }

    public void updateBoard(ChildrenRequest request) {
