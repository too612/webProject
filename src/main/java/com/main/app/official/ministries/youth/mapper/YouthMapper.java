package com.main.app.official.ministries.youth.mapper;
...
@Component
public class YouthMapper {

    private static final String BOARD_TYPE = "YOUTH";

    private final YouthBoardMapper boardMapper;

    public YouthMapper(YouthBoardMapper boardMapper) {
        this.boardMapper = boardMapper;
    }

    public List<YouthDto> selectBoardList(Pageable pageable, String searchType, String keyword) {
    ...
    public YouthDto selectBoardDetail(String rqstNo, boolean increaseViewCount) {
        Map<String, Object> params = new HashMap<>();
    ...
    public void insertBoard(YouthRequest request) {
        boardMapper.insertBoard(request);
    }

    public void updateBoard(YouthRequest request) {
