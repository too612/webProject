...
import { useGalleryContent } from './galleryHook';
import { DEFAULT_GALLERY_CONTENT } from './galleryModel';

export default function GalleryPage() {
  const { galleryContent, loading, error, loadGalleryContent } = useGalleryContent();

  useEffect(() => {
    loadGalleryContent();
  }, [loadGalleryContent]);

  const content = galleryContent ?? DEFAULT_GALLERY_CONTENT;
