...
import { CHILDREN_BASE_PATH } from '../../official/ministries/children/childrenModel';
...
import { ANNOUNCEMENT_BASE_PATH } from '../../official/news/announcement/announcementModel';
import { BULLETIN_BASE_PATH } from '../../official/news/bulletin/bulletinModel';
import { REGISTRATION_BASE_PATH } from '../../official/news/registration/registrationModel';
import { QNA_BASE_PATH } from '../../official/support/qna/qnaModel';
...
export const fallbackMenuBySystem: Record<string, MenuItem[]> = {
  official: [
    ...
    },
    {
      ...
      menuName: '사역',
      path: CHILDREN_BASE_PATH,
      level: 1,
      orderNo: 3,
      subMenus: [
        { menuId: 'official-ministries-children', menuName: '어린이사역', path: CHILDREN_BASE_PATH, parentId: 'official-ministries', level: 2, orderNo: 1, subMenus: [] },
        { menuId: 'official-ministries-youth', menuName: '청년사역', path: YOUTH_BASE_PATH, parentId: 'official-ministries', level: 2, orderNo: 2, subMenus: [] },
        { menuId: 'official-ministries-mission', menuName: '선교사역', path: MISSION_BASE_PATH, parentId: 'official-ministries', level: 2, orderNo: 3, subMenus: [] },
      ],
    },
    {
      menuId: 'official-news',
      menuName: '소식',
      path: ANNOUNCEMENT_BASE_PATH,
      level: 1,
      orderNo: 4,
      subMenus: [
        { menuId: 'official-news-announcement', menuName: '공지사항', path: ANNOUNCEMENT_BASE_PATH, parentId: 'official-news', level: 2, orderNo: 1, subMenus: [] },
        { menuId: 'official-news-bulletin', menuName: '주보', path: BULLETIN_BASE_PATH, parentId: 'official-news', level: 2, orderNo: 2, subMenus: [] },
        { menuId: 'official-news-registration', menuName: '새가족등록', path: REGISTRATION_BASE_PATH, parentId: 'official-news', level: 2, orderNo: 3, subMenus: [] },
    ...
    },
    {
      ...
      subMenus: [
        ...
        { menuId: 'official-support-qna', menuName: 'Q&A', path: QNA_BASE_PATH, parentId: 'official-support', level: 2, orderNo: 3, subMenus: [] },
      ],
    },
  ],
  community: [
