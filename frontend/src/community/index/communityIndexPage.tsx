                ...
                <div className="container mx-auto px-4 space-y-6">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        {loading ? (
                            ...
                            <article className="bg-white rounded-panel shadow-panel border border-gray-100 p-5 space-y-2" key={post.id || post.title}>
                                <div className="flex items-center justify-between">
                        ...
                        <div className="bg-white rounded-panel shadow-panel border border-gray-100 overflow-hidden">
                            ...
                            <ul className="divide-y divide-gray-100">
                                {(indexData.notices.length > 0
                                    ...
                                    <li key={item.id || item.title} className="flex items-center justify-between px-5 py-3">
