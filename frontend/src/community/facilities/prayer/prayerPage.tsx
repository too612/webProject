import {
  COMMUNITY_FACILITIES_PRAYER_COLUMNS,
  type CommunityFacilitiesPrayerRow,
} from "./prayerModel";
...
export default function FacilitiesPrayerPage() {
  ...
  const getCellValue = (
    row: CommunityFacilitiesPrayerRow,
    key: string,
  ): string => {
    const value = row[key];
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            {loading && (
              <tr>
                <td
                  colSpan={COMMUNITY_FACILITIES_PRAYER_COLUMNS.length + 1}
