import { COMMUNITY_GROUP_B2_COLUMNS, type CommunityGroupB2Row } from './b2Model';
import { useCommunityGroupB2Page } from './b2Hook';

export default function GroupB2Page() {
    const { items, totalMembers, loading, error } = useCommunityGroupB2Page();
        ...
        <section className="space-y-4">
            <div className="flex flex-wrap items-start justify-between gap-4">
                <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-gray-500">B2 구역 구성원과 출석 현황을 확인합니다.</p>
                </div>
                <button
                    type="button"
            ...
            <div className="grid grid-cols-3 gap-3">
                ...
                <div className="bg-white rounded-panel shadow-panel border border-gray-100 px-5 py-4 text-center">
                    ...
                    <strong className="text-2xl font-bold text-brand-dark">88%</strong>
                </div>
                <div className="bg-white rounded-panel shadow-panel border border-gray-100 px-5 py-4 text-center">
                    <p className="text-xs text-gray-500 mb-1">이번 달 모임</p>
                    <strong className="text-2xl font-bold text-brand-dark">4회</strong>
                </div>
            </div>
